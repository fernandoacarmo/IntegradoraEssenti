...
{
    /// <summary>
    /// Classe referente a tabela ESTFornecedor
    /// </summary>
    [XmlType("ESTFORNECEDOR")]
    public class ESTFornecedor : OracleTable
    {
        #region Atributos
        ...
        /// <summary>
        /// Propriedade referente ao campo: TIPOFORNECEDOR
        /// Comentário: 
        /// </summary>
        private string tipofornecedor;
        [XmlElement(ElementName = "TIPOFORNECEDOR", DataType = "VARCHAR2", IsNullable = true)]
        ...
        {
            return "ESTFORNECEDOR";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<ESTFornecedor> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTFornecedor.GetStringConnection());
            return ba.Listar<ESTFornecedor>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTFornecedor> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTFornecedor.GetStringConnection());
            return ba.Existe<ESTFornecedor>(where);
        }
