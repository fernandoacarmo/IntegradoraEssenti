...
{
    /// <summary>
    /// Classe referente a tabela ESTPrePedidosaidaitens
    /// </summary>
    [XmlType("ESTPREPEDIDOSAIDAITENS")]
    public class ESTPrePedidosaidaitens : OracleTable
    {
        #region Atributos
        ...
        {
            return "ESTPREPEDIDOSAIDAITENS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<ESTPrePedidosaidaitens> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTPrePedidosaidaitens.GetStringConnection());
            return ba.Listar<ESTPrePedidosaidaitens>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTPrePedidosaidaitens> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTPrePedidosaidaitens.GetStringConnection());
            return ba.Existe<ESTPrePedidosaidaitens>(where);
        }
