...
{
    /// <summary>
    /// Classe referente a tabela PCPreequipewms
    /// </summary>
    [XmlType("PCPREEQUIPEWMS")]
    public class PCPreequipewms : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCPREEQUIPEWMS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCPreequipewms> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCPreequipewms>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCPreequipewms> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCPreequipewms>(where);
        }
