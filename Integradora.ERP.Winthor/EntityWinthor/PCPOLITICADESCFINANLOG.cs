...
{
    /// <summary>
    /// Classe referente a tabela PCPoliticadescfinanlog
    /// </summary>
    [XmlType("PCPOLITICADESCFINANLOG")]
    public class PCPoliticadescfinanlog : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCPOLITICADESCFINANLOG";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCPoliticadescfinanlog> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCPoliticadescfinanlog>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCPoliticadescfinanlog> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCPoliticadescfinanlog>(where);
        }
