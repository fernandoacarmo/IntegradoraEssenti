...
{
    /// <summary>
    /// Classe referente a tabela PCInutilizacaocte
    /// </summary>
    [XmlType("PCINUTILIZACAOCTE")]
    public class PCInutilizacaocte : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCINUTILIZACAOCTE";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCInutilizacaocte> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCInutilizacaocte>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCInutilizacaocte> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCInutilizacaocte>(where);
        }
