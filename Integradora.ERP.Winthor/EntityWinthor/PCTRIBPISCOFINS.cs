...
{
    /// <summary>
    /// Classe referente a tabela PCTribpiscofins
    /// </summary>
    [XmlType("PCTRIBPISCOFINS")]
    public class PCTribpiscofins : OracleTable
    {
        #region Atributos
        ...
        /// Comentário: Considera Preço da mercadoria
        /// </summary>
        ...
        /// Comentário: Código Situação Tributária
        /// </summary>
        ...
        /// Comentário: Cod. Situação Tributária do PIS/COFINS
        /// </summary>
        ...
        /// </summary>
        public static List<PCTribpiscofins> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCTribpiscofins>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCTribpiscofins> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCTribpiscofins>(where);
        }
