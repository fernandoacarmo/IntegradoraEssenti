...
{
    /// <summary>
    /// Classe referente a tabela PCMensagemcce
    /// </summary>
    [XmlType("PCMENSAGEMCCE")]
    public class PCMensagemcce : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCMENSAGEMCCE";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCMensagemcce> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCMensagemcce>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCMensagemcce> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCMensagemcce>(where);
        }
