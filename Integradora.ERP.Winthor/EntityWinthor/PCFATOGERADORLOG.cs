...
{
    /// <summary>
    /// Classe referente a tabela PCFatogeradorlog
    /// </summary>
    [XmlType("PCFATOGERADORLOG")]
    public class PCFatogeradorlog : OracleTable
    {
        #region Atributos
        ...
        /// Comentário: Indica a data da inserção do registro na tabela.
        /// </summary>
        private DateTime? datalog;
        [XmlElement(ElementName = "DATALOG", DataType = "DATE", IsNullable = true)]
        ...
        /// <summary>
        /// Propriedade referente ao campo: IDFATOGERADOR
        /// Comentário: Número sequencial único usado como chave primária
        /// </summary>
        private decimal idfatogerador;
        [XmlElement(ElementName = "IDFATOGERADOR", DataType = "NUMBER", IsNullable = false)]
        [DataObjectField(true,false,false,10)]
        public decimal Idfatogerador
        {
            get { return  idfatogerador; }
            set {  idfatogerador = value; }
        }
        ...
        {
            return "PCFATOGERADORLOG";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCFatogeradorlog> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCFatogeradorlog>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCFatogeradorlog> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCFatogeradorlog>(where);
        }
