...
{
    /// <summary>
    /// Classe referente a tabela PCRegcobc
    /// </summary>
    [XmlType("PCREGCOBC")]
    public class PCRegcobc : OracleTable
    {
        #region Atributos
        ...
        /// </summary>
        public static List<PCRegcobc> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCRegcobc>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCRegcobc> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCRegcobc>(where);
        }
