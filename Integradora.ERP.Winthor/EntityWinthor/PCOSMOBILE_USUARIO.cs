...
{
    /// <summary>
    /// Classe referente a tabela PCOsmobile_usuario
    /// </summary>
    [XmlType("PCOSMOBILE_USUARIO")]
    public class PCOsmobile_usuario : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCOSMOBILE_USUARIO";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCOsmobile_usuario> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCOsmobile_usuario>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCOsmobile_usuario> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCOsmobile_usuario>(where);
        }
