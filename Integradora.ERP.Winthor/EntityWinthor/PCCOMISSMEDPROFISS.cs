...
{
    /// <summary>
    /// Classe referente a tabela PCComissmedprofiss
    /// </summary>
    [XmlType("PCCOMISSMEDPROFISS")]
    public class PCComissmedprofiss : OracleTable
    {
        #region Atributos
        ...
        {
            return "PCCOMISSMEDPROFISS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCComissmedprofiss> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCComissmedprofiss>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCComissmedprofiss> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCComissmedprofiss>(where);
        }
