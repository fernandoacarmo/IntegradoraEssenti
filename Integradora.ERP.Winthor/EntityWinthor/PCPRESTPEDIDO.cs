...
{
    /// <summary>
    /// Classe referente a tabela PCPrestpedido
    /// </summary>
    [XmlType("PCPRESTPEDIDO")]
    public class PCPrestpedido : OracleTable
    {
        #region Atributos
        ...
        /// Comentário: CONTA CORRENTE DA FORMA DE PAGAMENTO DO PEDIDO.
        /// </summary>
        private decimal contacorrente;
        [XmlElement(ElementName = "CONTACORRENTE", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false,false,true,10)]
        public decimal Contacorrente
        {
        ...
        /// <summary>
        /// Propriedade referente ao campo: POS
        /// Comentário: POS DA FORMA DE PAGAMENTO DO PEDIDO.
        /// </summary>
        private string pos;
        [XmlElement(ElementName = "POS", DataType = "VARCHAR2", IsNullable = true)]
        [DataObjectField(false,false,true,1)]
        public string Pos
        {
            get { return  pos; }
        ...
        /// <summary>
        /// Propriedade referente ao campo: VALORPAGOORI
        /// Comentário: VALOR PAGO ORIGINAL DA FORMA DE PAGAMENTO DO PEDIDO.
        /// </summary>
        private decimal valorpagoori;
        [XmlElement(ElementName = "VALORPAGOORI", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false,false,true,12)]
        public decimal Valorpagoori
        {
            get { return  valorpagoori; }
            set {  valorpagoori = value; }
        }
        ...
        {
            return "PCPRESTPEDIDO";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<PCPrestpedido> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<PCPrestpedido>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<PCPrestpedido> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<PCPrestpedido>(where);
        }
