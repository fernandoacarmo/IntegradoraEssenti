...
{
    /// <summary>
    /// Classe referente a tabela ESTColaboradores
    /// </summary>
    [XmlType("ESTCOLABORADORES")]
    public class ESTColaboradores : OracleTable
    {
        #region Atributos
        ...
        [XmlElement(ElementName = "CONFERENTEMASTER", DataType = "VARCHAR2", IsNullable = false)]
        ...
        [XmlElement(ElementName = "DTADMISSAO", DataType = "DATE", IsNullable = false)]
        ...
        /// </summary>
        private string sexo;
        [XmlElement(ElementName = "SEXO", DataType = "VARCHAR2", IsNullable = false)]
        [DataObjectField(false,false,false,1)]
        public string Sexo
        {
            get { return  sexo; }
        ...
        {
            return "ESTCOLABORADORES";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<ESTColaboradores> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTColaboradores.GetStringConnection());
            return ba.Listar<ESTColaboradores>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTColaboradores> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTColaboradores.GetStringConnection());
            return ba.Existe<ESTColaboradores>(where);
        }
