...
{
    /// <summary>
    /// Classe referente a tabela Estreplicacao_Corpem
    /// </summary>
    [XmlType("ESTREPLICACAO_CORPEM")]
    public class Estreplicacao_Corpem : OracleTable
    {
        #region Atributos
        ...
        {
            return "ESTREPLICACAO_CORPEM";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Estreplicacao_Corpem> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<Estreplicacao_Corpem>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Estreplicacao_Corpem> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<Estreplicacao_Corpem>(where);
        }
