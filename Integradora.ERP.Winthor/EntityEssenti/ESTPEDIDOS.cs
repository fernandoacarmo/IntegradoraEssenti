...
{
    /// <summary>
    /// Classe referente a tabela ESTPedidos
    /// </summary>
    [XmlType("ESTPEDIDOS")]
    public class ESTPedidos : OracleTable
    {
        #region Atributos
        ...
        /// </summary>
        public static List<ESTPedidos> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTPedidos.GetStringConnection());
            return ba.Listar<ESTPedidos>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTPedidos> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTPedidos.GetStringConnection());
            return ba.Existe<ESTPedidos>(where);
        }
