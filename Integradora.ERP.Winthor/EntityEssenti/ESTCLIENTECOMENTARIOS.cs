...
{
    /// <summary>
    /// Classe referente a tabela ESTClientecomentarios
    /// </summary>
    [XmlType("ESTCLIENTECOMENTARIOS")]
    public class ESTClientecomentarios : OracleTable
    {
        #region Atributos
        ...
        {
            return "ESTCLIENTECOMENTARIOS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<ESTClientecomentarios> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTClientecomentarios.GetStringConnection());
            return ba.Listar<ESTClientecomentarios>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTClientecomentarios> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTClientecomentarios.GetStringConnection());
            return ba.Existe<ESTClientecomentarios>(where);
        }
