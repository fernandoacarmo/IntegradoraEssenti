...
namespace Integradora.ERP.Winthor.EntityEssenti
{
    ...
    /// </summary>
    [XmlType("ESTREPLICACAO_VTIGER")]
    public class Estreplicacao_VTiger : OracleTable
    {
        #region Atributos
        ...
        {
            return "ESTREPLICACAO_VTIGER";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Estreplicacao_VTiger> Listar(string where)
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Listar<Estreplicacao_VTiger>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Estreplicacao_VTiger> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(GetStringConnection());
            return ba.Existe<Estreplicacao_VTiger>(where);
        }
