...
{
    /// <summary>
    /// Classe referente a tabela Esvlogestpedidositens
    /// </summary>
    [XmlType("ESVLOGESTPEDIDOSITENS")]
    public class Esvlogestpedidositens : OracleView
    {
        #region Atributos
        ...
        [XmlElement(ElementName = "CESTAMONTADA", DataType = "VARCHAR2", IsNullable = true)]
        ...
        {
            return "ESVLOGESTPEDIDOSITENS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvlogestpedidositens> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvlogestpedidositens.GetStringConnection());
            return ba.Listar<Esvlogestpedidositens>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvlogestpedidositens> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvlogestpedidositens.GetStringConnection());
            return ba.Existe<Esvlogestpedidositens>(where);
        }
