...
{
    /// <summary>
    /// Classe referente a tabela Esvprodutosinsumos
    /// </summary>
    [XmlType("ESVPRODUTOSINSUMOS")]
    public class Esvprodutosinsumos : OracleView
    {
        #region Atributos
        ...
        {
            return "ESVPRODUTOSINSUMOS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvprodutosinsumos> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvprodutosinsumos.GetStringConnection());
            return ba.Listar<Esvprodutosinsumos>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvprodutosinsumos> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvprodutosinsumos.GetStringConnection());
            return ba.Existe<Esvprodutosinsumos>(where);
        }
