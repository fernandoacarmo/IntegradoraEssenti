...
{
    /// <summary>
    /// Classe referente a tabela Esvprodutoscestas
    /// </summary>
    [XmlType("ESVPRODUTOSCESTAS")]
    public class Esvprodutoscestas : OracleView
    {
        #region Atributos
        ...
        {
            return "ESVPRODUTOSCESTAS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvprodutoscestas> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvprodutoscestas.GetStringConnection());
            return ba.Listar<Esvprodutoscestas>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvprodutoscestas> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvprodutoscestas.GetStringConnection());
            return ba.Existe<Esvprodutoscestas>(where);
        }
