...
{
    /// <summary>
    /// Classe referente a tabela Esvlogestcarregamentos
    /// </summary>
    [XmlType("ESVLOGESTCARREGAMENTOS")]
    public class Esvlogestcarregamentos : OracleView
    {
        #region Atributos
        ...
        [XmlElement(ElementName = "VLENTREGA", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false,false,true,22)]
        ...
        {
            return "ESVLOGESTCARREGAMENTOS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvlogestcarregamentos> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvlogestcarregamentos.GetStringConnection());
            return ba.Listar<Esvlogestcarregamentos>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvlogestcarregamentos> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvlogestcarregamentos.GetStringConnection());
            return ba.Existe<Esvlogestcarregamentos>(where);
        }
