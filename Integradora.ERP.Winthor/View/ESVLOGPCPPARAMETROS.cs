...
{
    /// <summary>
    /// Classe referente a tabela Esvlogpcpparametros
    /// </summary>
    [XmlType("ESVLOGPCPPARAMETROS")]
    public class Esvlogpcpparametros : OracleView
    {
        #region Atributos
        ...
        {
            return "ESVLOGPCPPARAMETROS";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvlogpcpparametros> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvlogpcpparametros.GetStringConnection());
            return ba.Listar<Esvlogpcpparametros>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvlogpcpparametros> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvlogpcpparametros.GetStringConnection());
            return ba.Existe<Esvlogpcpparametros>(where);
        }
