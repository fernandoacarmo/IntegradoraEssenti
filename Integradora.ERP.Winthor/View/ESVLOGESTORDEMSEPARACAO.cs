...
{
    /// <summary>
    /// Classe referente a tabela Esvlogestordemseparacao
    /// </summary>
    [XmlType("ESVLOGESTORDEMSEPARACAO")]
    public class Esvlogestordemseparacao : OracleView
    {
        #region Atributos
        ...
        [XmlElement(ElementName = "AMOSTRA", DataType = "VARCHAR2", IsNullable = true)]
        ...
        [XmlElement(ElementName = "SEPARADOR_ID", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false,false,true,8)]
        ...
        [XmlElement(ElementName = "TIPOSEPARACAO", DataType = "NUMBER", IsNullable = true)]
        ...
        [XmlElement(ElementName = "VLHORASEPARADOR", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false,false,true,22)]
        ...
        /// Método create
        /// </summary>
        public Esvlogestordemseparacao()
        {
        }
        ...
        {
            return "ESVLOGESTORDEMSEPARACAO";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<Esvlogestordemseparacao> Listar(string where)
        {
            Persistencia ba = new Persistencia(Esvlogestordemseparacao.GetStringConnection());
            return ba.Listar<Esvlogestordemseparacao>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<Esvlogestordemseparacao> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(Esvlogestordemseparacao.GetStringConnection());
            return ba.Existe<Esvlogestordemseparacao>(where);
        }
