...
{
    /// <summary>
    /// Classe referente a tabela ESTFabricante
    /// </summary>
    [XmlType("ESTFABRICANTE")]
    public class ESTFabricante : BaseAjuri
    {
        #region Atributos
        ...
        {
            return "ESTFABRICANTE";
        }

        /// <summary>
        /// Obter lista do objeto, com condição de pesquisa
        /// </summary>
        public static List<ESTFabricante> Listar(string where)
        {
            Persistencia ba = new Persistencia(ESTFabricante.GetStringConnection());
            return ba.Listar<ESTFabricante>(where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<ESTFabricante> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(ESTFabricante.GetStringConnection());
            return ba.Existe<ESTFabricante>(where);
        }
