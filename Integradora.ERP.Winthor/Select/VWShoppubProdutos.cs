...
{
    /// <summary>
    /// Classe referente ao select VWShoppubProdutos
    /// </summary>
    [XmlType("VWSHOPPUBPRODUTOS")]
    public class VWShoppubProdutos : OracleSelect
    {
        #region Métodos
        /// <summary>
        /// Método create
        /// </summary>
        public VWShoppubProdutos()
        {
        }
        ...
        /// </summary>
        public static List<VWShoppubProdutos> Listar(string where)
        {
            //string filtro = where.ToUpper().Replace("ROWID", "OID");
            Persistencia ba = new Persistencia(VWShoppubProdutos.GetStringConnection());
            return ba.Listar<VWShoppubProdutos>(GetSelect(), where);
        }

        /// <summary>
        /// Obter lista do objeto, sem condição de pesquisa
        /// </summary>
        public static List<VWShoppubProdutos> Listar()
        {
            return Listar("1=1");
        }
        ...
        {
            Persistencia ba = new Persistencia(VWShoppubProdutos.GetStringConnection());
            return ba.Existe<VWShoppubProdutos>(where);
        }
            ...
            script = string.Format(
                  @"SELECT B.*
                       FROM (SELECT A.*
                                  ...
                                  , PCMARCA.IDFABRICANTE_SHOPPUB IDFABRICANTE
                                  , PCMARCA.MARCA
                               ...
                               FROM (SELECT PCPRODUT.CODPROD
                                          ...
                                          , PCPRODUT.CODFAB
                                          , ROUND(NVL(PCPRODUT.PESOLIQ, 0), 0) * 1000 PESOLIQ
                              ...
                              WHERE A.CODEPTO = PCDEPTO.CODEPTO
                                ...
                                AND A.CODMARCA = PCMARCA.CODMARCA (+)
        ...
        /// <summary>
        /// Propriedade referente ao campo: IDFABRICANTE_SHOPPUB DA TABELA PCMARCA
        /// Comentário: 
        /// </summary>
        private decimal idfabricante;
        [XmlElement(ElementName = "IDFABRICANTE", DataType = "NUMBER", IsNullable = true)]
        [DataObjectField(false, false, true, 8)]
        public decimal IdFabricante
        {
            get { return idfabricante; }
